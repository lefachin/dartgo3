...
const [const Directive(bindings: const [SELECT_VALUE_ACCESSOR], host: const {"(input)" : "onChange(\$event.target.value)", "(blur)" : "onTouched()"}, selector: "select[ngControl],select[ngFormControl],select[ngModel]")],
